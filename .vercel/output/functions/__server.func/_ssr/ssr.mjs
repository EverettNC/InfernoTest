...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Xh24zuQV.mjs");
...
var manifest = {
	"16cabd67e47d8b73706e7828bf28f6d6454d069a3111f43c0ff4ef6339005faf": {
		functionName: "speakInferno_createServerFn_handler",
		importer: () => import("./ai-DwxYwAPo.mjs")
	},
	"5c7c8a975719ff8b7e9e16b9422951e00cd52f98652c087728ca1db309337e4f": {
		functionName: "thinkInferno_createServerFn_handler",
		importer: () => import("./ai-DwxYwAPo.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-JafYSROI.mjs").then((n) => n.t),
