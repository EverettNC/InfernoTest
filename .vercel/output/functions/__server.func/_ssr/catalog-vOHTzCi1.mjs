//#region node_modules/.nitro/vite/services/ssr/assets/catalog-vOHTzCi1.js
var CIRCLES = [
	{
		id: "combat-veterans",
		name: "Combat Veterans Brotherhood",
		category: "Combat Veterans",
		blurb: "For those who served in combat zones. Share the weight with people who already know the sound.",
		holds: [
			"Combat trauma",
			"Peer mentorship",
			"Night watches"
	...
	},
	{
		...
		blurb: "A closed circle for veterans battling PTSD. Evidence, not slogans. Hope, not pressure.",
		holds: [
			"Trauma-informed care",
			"Coping drills",
			"Medication-adjacent talk, no prescribing"
		],
		crisis: "Veterans Crisis Line — 988, press 1"
	},
	{
		...
		blurb: "The move back to civilian life — career, paper, identity. The uniform comes off. You do not.",
		holds: [
			"Career guidance",
			"Education benefits",
			"Reintegration"
	...
	},
	{
		...
		blurb: "MST recovery and career advancement. Gender-specific support that does not talk over you.",
		holds: [
			"MST recovery",
			"Career",
			"Women-only space"
	...
	},
	{
		...
		blurb: "Spouses, children, families. Healing together without making the veteran the only story.",
		holds: [
			"Family systems",
			"Child support",
			"Caregiver rest"
	...
	},
	{
		...
		blurb: "Active recovery from crisis or addiction. Rise is not a metaphor. It is a schedule.",
		holds: [
			"Recovery",
			"Life rebuilding",
...
var PROGRAMS = [
	{
		...
		summary: "Four free self-guided modules: trauma-informed principles, neurobiology, practical implementation."
	},
	{
		...
		summary: "Trauma reactions, de-escalation, resilience. Used by organizations worldwide."
	},
	{
		...
		summary: "Free six-module professional certificate. Veteran and justice-involved modules included."
	},
	{
		...
		summary: "Trauma screening, trauma-focused CBT, community trauma systems. Federal CEUs."
	},
	{
		id: "va-ptsd-training",
		...
		summary: "Prolonged exposure, trauma assessment, cultural issues in PTSD care. Free worldwide."
	},
	{
		id: "emdr-intro",
	...
	},
	{
		...
		summary: "52-hour virtual EMDR track. Occasionally funded. For qualified clinicians."
	},
	{
		...
		summary: "Trauma resilience program for PTSD-affected veterans. Retreats and follow-up."
	},
	{
...
var MEDITATIONS = [
	{
		...
		name: "Body scan",
		minutes: 8,
		script: "Start at the crown. Notice temperature, pressure, contact. Move slowly to the jaw. Unclench if you can. Shoulders. Hands. The ribcage moving. The belly. The sit bones. The feet. You do not have to like what you find. You only have to notice it is here, and that you are too."
	},
	{
		id: "orient",
		name: "Orient to now",
		minutes: 4,
		script: "Name the room. Name the year. Name one object that was not in the memory. Feel the chair. That was then. This is now. Stay with the object for three breaths."
	},
	{
		id: "safe-place",
		name: "Safe place imagery",
		minutes: 6,
		script: "Pick a place that does not demand anything of you. Color. Sound. Temperature. Who is allowed in — maybe no one. You can leave whenever you want. This image is a tool, not a trap."
	}
];
var LOUNGES = [
	{
...
var CAPABILITIES = [
	{
		id: "crisis-bar",
		name: "Crisis bar on every screen",
		section: "Guardian"
	},
	{
		id: "crisis-detect",
		name: "Crisis detection 4-tier ladder",
		section: "Guardian"
	},
	{
		id: "protocol-select",
	...
	{
		id: "no-diagnose",
		name: "No diagnose / no prescribe",
		section: "Guardian"
	},
	{
		id: "bridge-queue",
		name: "Bridge notify queue (honest)",
		section: "Guardian"
	},
	{
		id: "grounding",
	...
	{
		id: "community",
		name: "Six support circles",
		section: "Senses"
	},
	{
		id: "training",
		name: "Professional Training Hub",
		section: "Cortex"
	},
	{
		id: "study-partner",
	...
	{
		id: "privacy",
		name: "Privacy consent + local store",
		section: "Vault"
	},
	{
		id: "export-wipe",
		name: "Export and full wipe",
		section: "Vault"
	},
	{
		id: "integrity",
		name: "Named failures, never a fake win",
		section: "Cortex"
	},
	{
		id: "resources",
...
//#endregion
export { MODULES as a, MEDITATIONS as i, CIRCLES as n, PROGRAMS as o, LOUNGES as r, CAPABILITIES as t };
